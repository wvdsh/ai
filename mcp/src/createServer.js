    ...
    async ({ engine, features }) => {
      ...
      return textContent(
        [
          ...
          "",
          "Install it using the official CLI install docs, then authenticate:",
          "",
    ...
    async ({ engine, features }) => {
      ...
      return textContent(
        [
          ...
          "3. Configure wavedash.toml with game_id, upload_dir, and entrypoint.",
          "4. Test with wavedash dev.",
          "5. Push a build with wavedash build push.",
